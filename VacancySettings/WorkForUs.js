...
function ValidateVacancyForm() {
    ...
    if (document.getElementById("ukResidentYes").checked == false && document.getElementById("ukResidentNo").checked == false) {
        document.getElementById("ukResidentError").innerHTML = "Select an Option.";
        flag3 = false;
    }
    else {
    ...
    // EMAIL
    if (document.forms["VacancyApplicationForm"]["Email"].value == "") {
        //set the error text
    ...
    if (document.forms["VacancyApplicationForm"]["telNo"].value == "") {
        document.getElementById("telNoError").innerHTML = "Enter your contact details below :";
        flag4 = false;
    }
        ...
        if (isNaN(telNo)) {//if its not a number..
            document.getElementById("telNoError").innerHTML = "Please make sure your contact details is a Mobile Phone Number and is correct.";
            flag4 = false;
        }
        else if (telNo.length < 10 || telNo.length > 12) {//check the length. Must be 11 numbers to be a mobile
            document.getElementById("telNoError").innerHTML = "Incorrect Telephone Number, please check and try again";
            flag4 = false;
        }
